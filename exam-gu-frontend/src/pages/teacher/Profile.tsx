                ...
                <div className="mt-8 pt-6 border-t border-gray-200">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="bg-blue-50 rounded-lg p-4">
                      <p className="text-sm text-blue-600 font-medium">Examens créés</p>
                      <p className="text-2xl font-bold text-blue-900 mt-2">-</p>
                    </div>
                    <div className="bg-green-50 rounded-lg p-4">
                      <p className="text-sm text-green-600 font-medium">Sessions assignées</p>
                      <p className="text-2xl font-bold text-green-900 mt-2">-</p>
                    </div>
                    <div className="bg-purple-50 rounded-lg p-4">
                      <p className="text-sm text-purple-600 font-medium">Tentatives corrigées</p>
