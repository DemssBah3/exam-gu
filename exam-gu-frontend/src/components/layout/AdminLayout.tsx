...
export function AdminLayout() {
  ...
  const menuItems = [
    ...
    { icon: UserPlus, label: 'Inscriptions', path: '/admin/enrollments' },
    { icon: UserCheck, label: 'Assignations', path: '/admin/assignments' },
  ];
  ...
  const handleNavigate = (path: string) => {
    navigate(path);
    setIsSidebarOpen(false); // Fermer le menu mobile après navigation
  };
